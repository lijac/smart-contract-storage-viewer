...
class HexViewWithForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
        endpoint:
            "https://linea-mainnet.infura.io/v3/0dcb3217af5d493aa71a84f2d81cd2d3",
        etherscanApiKey: undefined,
        startslot:
            "0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103",
        numslots: 10,
        target: "0xD6FE0A87611dD4DBcD57ec15217D97c0408629B6",
        atBlock: "latest",
        data: new Array(),
        selectedTab: 0,
        txList: [],
  ...
  render() {
    ...
    return (
        <div>
                            ...
                            <tr>
                                <td>
                                    <input
                                        ...
                                        title="Target must be an Ethereum Address starting with 0x..."
                                ...
                                <td>
                                    <input
                                        ...
                                        name="atBlock"
                                        pattern="https?://.*"
                                        title="Field must be a HTTP(s)-URL."
                                        size={10}
                                        value={this.state.atBlock}
                                        onChange={(e) =>
                                            this.setState({
                                                atBlock: e.target.value.trim(),
                                                dirty: true,
                                            })
                                        }
                                    />
                                ...
                                <td>
                                    <div title="Get Api Key">
                                        ...
                                        />
                                        &nbsp;
                                        <a href="https://infura.io/register">
                                            ⓘ
                                        </a>
                                    </div>
                                </td>
            ...
            <Tabs
                onSelect={(index) =>
                    this.setState({ selectedTab: index, dirty: true })
                }
            >
                <TabList>
                    <Tab>💾 Storage</Tab>
                ...
                <TabPanel>
                    <div>
                            ...
                            <a
                                href={`https://${
                                    chainPrefix != "mainnet"
                                        ? `${chainPrefix}.`
                                        : ""
                                }etherscan.io/address/${this.state.target}`}
                                target="_blank"
                                rel="noreferrer"
                            >
                                🌐 Etherscan
                        ...
                        <div className="errorBox">
                            {this.state.error
                                ? `❗ StorageDecoder: ${this.state.error}`
                                : ""}
                            {this.state.errorEtherscan
                                ? `❗ TxDecoder: Etherscan Rate Limit :/ please provide an API-Key below`
                                : ""}
                        </div>
                        <HexEditor
                            className="hexview"
                    ...
                    <div className="mt-2 flex">
                        <div className="flex items-center text-sm text-gray-500">
                            <DynamicReactJson
                                ...
                                src={Object.keys(storageAnalysis).reduce(
                                    (result, key) => {
                                        result[key] =
                                            storageAnalysis[key].guess;
                                        return result;
                                    },
                                    {}
                                )}
                ...
                <TabPanel>
                    ...
                    <div title="Get Api Key Etherscan">
                        <input
                            ...
                            onChange={(e) =>
                                this.setState({
                                    etherscanApiKey: e.target.value.trim(),
                                    dirty: true,
                                })
                            }
                        />
                ...
                <TabPanel>
                    <div>
                        <span>
                            {" "}
                            🤫 open your browsers devtools (right-click →
                            inspect) and type <code> `window.tools ↵`</code>.
                        </span>
                        <br></br>
                        <br></br>
                        <br></br>
                        <code>
                            {" "}
                            ↦ window.tools.web3.utils.keccak256('hi')
                        </code>{" "}
                        <a
                        ...
                        <a
                            href="https://web3js.readthedocs.io/en/v1.7.5/web3-utils.html"
                            target="_blank"
                            rel="noreferrer"
                        >
                            [web3js-utils]
                ...
                <TabPanel>
                    <div>
                        ⇈{" "}
                        <sub>
                            <a href="https://github.com/tintinweb/smart-contract-storage-viewer">
                                Fork Me @
